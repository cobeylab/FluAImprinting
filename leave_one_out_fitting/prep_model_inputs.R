...
result_folder= sprintf("../results_ex2009.5_ex%s/", exclude_year) # Output folder for results
...
seasons = all_seasons = c(2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018)

seasons = seasons[seasons != as.numeric(exclude_year)]
all_seasons = seasons
